...
<%@page import="com.hzw.jsp.DataBaseOperator"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@page import="com.hzw.demo.*" %>
    <%--处理编码问题 --%>
    <%request.setCharacterEncoding("UTF-8");%>
    <%--使用JavaBean --%>
    <jsp:useBean id="student" scope="page" class="com.hzw.demo.Student"/>
...
if(method==4){
	%>
	<form action="/JSPDemo/DataAccess.jsp?op=2" method='post' target="workspace">
	<%
	while(it.hasNext()){
		Student st = it.next();
	...
	<a href="/JSPDemo/DataAccess.jsp?op=3">返回查询页面</a>
	</form>
<%
}
	else
